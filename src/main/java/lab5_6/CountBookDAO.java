...
public class CountBookDAO implements DAO<CountBook, Integer> {
     ...
     */
    @Override
    public boolean update(lab5_6.CountBook countBook) throws SQLException {
     ...
     */
    @Override
    public boolean delete(lab5_6.CountBook countBook) throws SQLException {
     ...
     */
    @Override
    public lab5_6.CountBook resultSetToObj(ResultSet rs) throws SQLException {
        lab5_6.CountBook count_book = new CountBook();
