...
public class  WorkerDAO implements DAO<lab5_6.Worker, Integer> {
     ...
     */
    @Override
    public boolean create(lab5_6.Worker worker) {
    ...
    public Worker read(Integer id) {
        lab5_6.Worker result = new lab5_6.Worker();
        result.setId(-1);
     ...
     */
    @Override
    public boolean update(lab5_6.Worker worker) {
        boolean result = false;
     ...
     */
    @Override
    public boolean delete(lab5_6.Worker worker) {
        boolean result = false;
     ...
     * @throws SQLException
     */
    public lab5_6.Worker resultSetToObj(ResultSet rs) throws SQLException {
        lab5_6.Worker worker = new lab5_6.Worker();
    ...
    public List<lab5_6.Worker> findAll() throws SQLException {
        List<lab5_6.Worker> list = new ArrayList<>();
